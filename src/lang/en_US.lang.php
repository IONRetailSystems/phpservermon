...
"text":"servermon: #message"}',
 ...
 profile.',
	...
	'green_sms' => 'Server %LABEL% is Functioning Properly, No Sensor or Server Issues Observed. Previous Issues lasted for %LAST_OFFLINE_DURATION%',
        ...
        'green_email_body' => 'Server: %LABEL% <br>is Functioning Properly, No Sensor or Server Issues Observed. Previous issues lasted for %LAST_OFFLINE_DURATION%:<br><br>Server: %LABEL%<br>IP: %IP%<br>Port: %PORT%<br>Date:  %DATE%',
        ...
        'yellow_email_subject' => 'IMPORTANT: Server %LABEL% Server Issues Reported',
        'yellow_email_body' => 'Server: %LABEL%<br>Server Issues Reported:<br>Error: %ERROR%<br>Date: %DATE%',
        ...
        'red_email_body' => 'PAX System reports Sensor Problems<br>Server: %LABEL%<br>Error: %ERROR%<br>Date: %DATE%',
    ...
    'login' => array(
        ...
        'password_reset_email_subject' => 'Reset your password for ION Monitoring System',
